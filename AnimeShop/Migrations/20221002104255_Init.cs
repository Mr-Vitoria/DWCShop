        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeOfAcc = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductsList_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FavoriteProducts_ProductsList_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderProducts_ProductsList_ProductId",
                        column: x => x.ProductId,
                        principalTable: "ProductsList",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "FirstName", "Login", "Password", "Phone", "SurName", "TypeOfAcc" },
                values: new object[] { 1, "olegnikod3@gmail.com", "Vivi", "Vitoria", "3214545454DIma", "89209972501", "Olei", "Admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsList_CategoryId",
                table: "ProductsList",
                column: "CategoryId");
        }
